...
export default function (pi: ExtensionAPI) {
  ...
  // - clear_thinking: false  → Preserved Thinking: retain reasoning_content
  //   across turns so the model can continue its reasoning context
  // - preserve_thinking: true → keep reasoning blocks in the context
  //
  // Pi returns the complete, unmodified reasoning_content back to the API
  // on every turn (stored as "thinking" content blocks), satisfying the
  // requirement that all consecutive reasoning_content blocks exactly
  // match the original sequence generated by the model.
